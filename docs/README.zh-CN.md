...
- **Zeroclaw**：[Zeroclaw GitHub](https://github.com/zeroclaw-labs/zeroclaw) · [Zeroclaw 中文文档](https://zeroclaws.io/zh/) — Provider、Agent、Skills、Tools、Runtime、Gateway、Channels 等与 pathfinder 对齐参考。
